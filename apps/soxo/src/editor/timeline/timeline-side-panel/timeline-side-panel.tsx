...
}> = memo(({inbetweenTrackDropTrackIndex}) => {
	// Subscribe directly to tracks layout - does NOT re-render when item properties change!
	// Only re-renders when tracks structure changes (add/remove/reorder tracks)
	const tracksAndLayout = useTracksWithLayout();
