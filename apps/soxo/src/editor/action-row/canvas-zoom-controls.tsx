	...
	return (
		<div className="flex h-full items-center rounded bg-white/5 text-white">
			...
			<button
				...
				className={`editor-starter-focus-ring flex h-full w-8 items-center justify-center border-r transition-colors ${
			...
			<div className="border-editor-starter-panel flex h-full min-w-[60px] cursor-default items-center justify-center border-x text-center text-xs font-medium">
