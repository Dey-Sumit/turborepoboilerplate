	...
	return (
		<>
			<div
				...
				className="dark:bg-input/30 border-input focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 flex flex-1 flex-row items-center border"
			>
				<div
				...
				<input
					...
					min={min ?? undefined}
					max={max ?? undefined}
					className="w-full flex-1 cursor-default [appearance:textfield] bg-transparent p-1.5 text-xs outline-hidden [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
					value={value}
					onChange={onChange}
