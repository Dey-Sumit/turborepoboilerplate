...
export const PlaybackControls: React.FC<{
	...
	const {fps} = useFps();
	return (
		<div className="border-t-editor-starter-border relative flex h-12 w-full shrink-0 flex-row items-center justify-between overflow-hidden border-t px-4 text-white">
