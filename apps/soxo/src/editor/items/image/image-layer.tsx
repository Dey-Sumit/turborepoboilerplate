...
const ImageItemUnmemoized: React.FC<{
	...
	const animationStyle = useMemo(() => {
		...
		// so we pass 0 as itemStartFrame instead of item.from
		if (item.animations) {
