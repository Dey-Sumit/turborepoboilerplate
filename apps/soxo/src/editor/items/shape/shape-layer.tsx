...
export const ShapeLayer: React.FC<{item: ShapeItem}> = ({item}) => {
	...
	// Merge animation styles with container style
	const mergedStyle = useMemo(() => {
		const merged = {...containerStyle};
