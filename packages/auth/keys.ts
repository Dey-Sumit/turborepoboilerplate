...
export const keys = () =>
  createEnv({
    server: {
      CLERK_SECRET_KEY: z.union([z.string().startsWith("sk_"), z.literal("")]).optional(),
      CLERK_WEBHOOK_SECRET: z.union([z.string().startsWith("whsec_"), z.literal("")]).optional(),
    },
    client: {
      NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY: z
        .union([z.string().startsWith("pk_"), z.literal("")])
        .optional(),
